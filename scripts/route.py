...
MODELS = {
    ("codex", "explore"): ("gpt-6-luna", "low"),
    ("codex", "mini"): ("gpt-6-luna", "low"),
    ("codex", "bulk"): ("gpt-6-luna", "low"),
    ("codex", "implement"): ("gpt-6-luna", "low"),
    ("codex", "hard"): ("gpt-5.6-terra", "medium"),
    ("codex", "verify"): ("gpt-6-luna", "low"),
    ("codex", "review"): ("gpt-5.6-terra", "high"),
    ("grok", "explore"): ("grok-4.5", "low"),
    ("grok", "mini"): ("grok-4.5", "low"),
    ("grok", "bulk"): ("grok-4.5", "low"),
    ("grok", "implement"): ("grok-4.7", "high"),
    ("grok", "hard"): ("grok-4.7", "high"),
    ("grok", "verify"): ("grok-4.7", "high"),
    ("grok", "review"): ("grok-4.7", "high"),
    ...
    ("claude", "hard"): ("claude-opus-5-5", "high"),
    ...
    ("cursor", "review"): ("claude-opus-5-5-thinking-high", ""),
    ...
    ("opencode", "implement"): ("openai/gpt-6-luna", "high"),
    ("opencode", "hard"): ("openai/gpt-5.6-terra", "max"),
    ("opencode", "verify"): ("openai/gpt-6-luna", "high"),
    ...
    ("omp", "review"): ("claude-opus-5-5", "high"),
    ...
    ("pi", "review"): ("claude-opus-5-5", "high"),
